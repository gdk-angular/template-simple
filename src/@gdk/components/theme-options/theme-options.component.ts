...
import { gdkAnimations } from '@gdk/animations';
...
@Component({
    selector     : 'gdk-theme-options',
    templateUrl  : './theme-options.component.html',
    styleUrls    : ['./theme-options.component.scss'],
    encapsulation: ViewEncapsulation.None,
    animations   : gdkAnimations
})
export class GdkThemeOptionsComponent implements OnInit, OnDestroy
{
    gdkConfig: any;
    form: FormGroup;
    ...
    ngOnInit(): void
    {
        ...
        this.form.valueChanges
            ...
            .subscribe((config) => {
                ...
                // Update the config
                this._gdkConfigService.config = config;
            });
        ...
        this._gdkNavigationService.addNavigationItem(customFunctionNavItem, 'end');
    }
    ...
    ngOnDestroy(): void
    {
        ...
        this._gdkNavigationService.removeNavigationItem('custom-function');
    }
            ...
            case 'vertical-layout-1':
            {
                this.form.patchValue({
                    layout: {
                        width    : 'fullwidth',
                        navbar   : {
                            primaryBackground  : 'gdk-navy-700',
                            secondaryBackground: 'gdk-navy-900',
                            folded             : false,
                            hidden             : false,
                            position           : 'left',
                        ...
                        toolbar  : {
                            background           : 'gdk-white-500',
                            customBackgroundColor: false,
                            hidden               : false,
                            position             : 'below-static'
                        },
                        footer   : {
                            background           : 'gdk-navy-900',
