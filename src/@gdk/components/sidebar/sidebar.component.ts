...
import { GdkSidebarService } from './sidebar.service';
...
@Component({
    selector     : 'gdk-sidebar',
    templateUrl  : './sidebar.component.html',
    styleUrls    : ['./sidebar.component.scss'],
    encapsulation: ViewEncapsulation.None
})
export class GdkSidebarComponent implements OnInit, OnDestroy
{
    // Name
    @Input()
    name: string;
    ...
    ngOnInit(): void
    {
        ...
        this._gdkConfigService.config
            ...
            .subscribe((config) => {
                this._gdkConfig = config;
            });

        // Register the sidebar
        this._gdkSidebarService.register(this.name, this);
    ...
    ngOnDestroy(): void
    {
        ...
        this._gdkSidebarService.unregister(this.name);
    ...
    private _showBackdrop(): void
    {
        ...
        this._backdrop.classList.add('gdk-sidebar-overlay');

        // Add a class depending on the invisibleOverlay option
        if ( this.invisibleOverlay )
        {
            this._backdrop.classList.add('gdk-sidebar-overlay-invisible');
        }
