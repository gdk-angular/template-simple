...
import { MatColors } from '@gdk/mat-colors';
import { ControlValueAccessor, NG_VALUE_ACCESSOR } from '@angular/forms';

export const GDK_MATERIAL_COLOR_PICKER_VALUE_ACCESSOR: any = {
    provide    : NG_VALUE_ACCESSOR,
    useExisting: forwardRef(() => GdkMaterialColorPickerComponent),
    multi      : true
};

@Component({
    selector     : 'gdk-material-color-picker',
    templateUrl  : './material-color-picker.component.html',
    styleUrls    : ['./material-color-picker.component.scss'],
    animations   : gdkAnimations,
    encapsulation: ViewEncapsulation.None,
    providers    : [GDK_MATERIAL_COLOR_PICKER_VALUE_ACCESSOR]
})
export class GdkMaterialColorPickerComponent implements ControlValueAccessor
{
    colors: any;
    hues: string[];
    view: string;
    ...
    set color(value)
    {
        ...
        // Split the color value (red-400, blue-500, gdk-navy-700 etc.)
