...
import '@gdk/components/highlight/prism-languages';

@Component({
    selector : 'gdk-highlight',
    template : '',
    styleUrls: ['./highlight.component.scss']
})
export class GdkHighlightComponent implements OnInit, OnDestroy
{
    // Source
    ...
    highlight(sourceCode): void
    {
        ...
        // can be formatted properly while using gdk-highlight
        // component
