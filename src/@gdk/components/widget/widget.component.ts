...
export class GdkWidgetComponent implements AfterContentInit
{
    @HostBinding('class.flipped')
    flipped = false;

    @ContentChildren(GdkWidgetToggleDirective, {descendants: true})
    toggleButtons: QueryList<GdkWidgetToggleDirective>;
