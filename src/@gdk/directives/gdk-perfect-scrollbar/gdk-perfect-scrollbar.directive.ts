...
import { GdkPerfectScrollbarGeometry, GdkPerfectScrollbarPosition } from '@gdk/directives/gdk-perfect-scrollbar/gdk-perfect-scrollbar.interfaces';
import { GdkConfigService } from '@gdk/services/config.service';

@Directive({
    selector: '[gdkPerfectScrollbar]'
})
export class GdkPerfectScrollbarDirective implements OnInit, AfterViewInit, OnDestroy
{
     ...
     */
    @Input()
    set gdkPerfectScrollbarOptions(value)
    {
        // Merge the options
    ...
    get gdkPerfectScrollbarOptions(): any
    {
        // Return the options
    ...
    ngAfterViewInit(): void
    {
        ...
        if ( this.gdkPerfectScrollbarOptions.updateOnRouteChange )
        {
            this._router.events
                .pipe(
                    takeUntil(this._unsubscribeAll),
    ...
    _init(): void
    {
        ...
        this.ps = new PerfectScrollbar(this.elementRef.nativeElement, {
            ...this.gdkPerfectScrollbarOptions
        });
     ...
     * @param prefix
     */
    geometry(prefix: string = 'scroll'): GdkPerfectScrollbarGeometry
    {
        return new GdkPerfectScrollbarGeometry(
     ...
     * @param absolute
     */
    position(absolute: boolean = false): GdkPerfectScrollbarPosition
    {
        if ( !absolute && this.ps )
        {
            return new GdkPerfectScrollbarPosition(
                this.ps.reach.x || 0,
                this.ps.reach.y || 0
            );
        }
