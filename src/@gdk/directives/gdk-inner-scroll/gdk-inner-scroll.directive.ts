...
export class GdkInnerScrollDirective implements OnInit, OnDestroy
{
    // Private
    private _parent: any;
     ...
     * @param {GdkMatchMediaService} _gdkMediaMatchService
     * @param {Renderer2} _renderer
     */
    constructor(
        private _elementRef: ElementRef,
        private _gdkMediaMatchService: GdkMatchMediaService,
    ...
    ngOnInit(): void
    {
        ...
        this._gdkMediaMatchService.onMediaChange
