...
@Component({
    selector   : 'gdk-nav-vertical-collapsable',
    templateUrl: './collapsable.component.html',
    styleUrls  : ['./collapsable.component.scss'],
    animations : gdkAnimations
})
export class GdkNavVerticalCollapsableComponent implements OnInit, OnDestroy
{
    @Input()
    ...
    ngOnInit(): void
    {
        ...
        this._gdkNavigationService.onItemCollapsed
    ...
    toggleOpen(ev): void
    {
        ...
        this._gdkNavigationService.onItemCollapsed.next(this.item);
        this._gdkNavigationService.onItemCollapseToggled.next();
    }
